...
l625:
	movlw	high(0C350h)
	movwf	((c:delay@i_31+1)),c
	movlw	low(0C350h)
	movwf	((c:delay@i_31)),c
	goto	l629
...
l627:
	decf	((c:delay@i_31)),c
	btfss	status,0
	decf	((c:delay@i_31+1)),c
	goto	l629
	
l18:
	
l629:
	movf	((c:delay@i_31)),c,w
iorwf	((c:delay@i_31+1)),c,w
	btfss	status,2
	goto	u21
	goto	u20
