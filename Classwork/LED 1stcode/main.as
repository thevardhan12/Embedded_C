...
l7:
	movff	(c:main@i),(c:3969)	;volatile
	line	13
...
l619:
	movlw	high(0)
	movwf	((c:main@i_25+1)),c
	movlw	low(0)
	movwf	((c:main@i_25)),c
	
l621:
	btfsc	((c:main@i_25+1)),c,7
	goto	u31
	movlw	233
	subwf	 ((c:main@i_25)),c,w
	movlw	3
	subwfb	((c:main@i_25+1)),c,w
	btfss	status,0
	goto	u31
	goto	u30
...
l625:
	infsnz	((c:main@i_25)),c
	incf	((c:main@i_25+1)),c
