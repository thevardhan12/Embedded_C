...
l763:
;main.c: 23: }
;main.c: 24: ssd[0]=data[i % 12];
	movff	(c:_i),(c:___llmod@dividend)
	movff	(c:_i+1),(c:___llmod@dividend+1)
	movff	(c:_i+2),(c:___llmod@dividend+2)
	movff	(c:_i+3),(c:___llmod@dividend+3)
	movlw	low(0Ch)
	movwf	((c:___llmod@divisor)),c
	movlw	high(0Ch)
	movwf	((c:___llmod@divisor+1)),c
	movlw	low highword(0Ch)
	movwf	((c:___llmod@divisor+2)),c
	movlw	high highword(0Ch)
	movwf	((c:___llmod@divisor+3)),c
	call	___llmod	;wreg free
	movlw	low(_data)
	addwf	(0+?___llmod),c,w
	movwf	c:fsr2l
	movlw	high(_data)
	addwfc	(1+?___llmod),c,w
	movwf	1+c:fsr2l
	movf	indf2,w
	movwf	((c:_ssd)),c
	line	25
...
l765:
;main.c: 25: ssd[1]=data[(i + 1)%12];
	movlw	01h
	addwf	((c:_i)),c,w
	movwf	((c:___llmod@dividend)),c
	movlw	0
	addwfc	((c:_i+1)),c,w
	movwf	1+((c:___llmod@dividend)),c
	
	movlw	0
	addwfc	((c:_i+2)),c,w
	movwf	2+((c:___llmod@dividend)),c
	
	movlw	0
	addwfc	((c:_i+3)),c,w
	movwf	3+((c:___llmod@dividend)),c
	movlw	low(0Ch)
	movwf	((c:___llmod@divisor)),c
	movlw	high(0Ch)
	movwf	((c:___llmod@divisor+1)),c
...
l723:
;main.c: 49: PORTA=(PORTA & 0Xf0 ) | (1<<i);
...
l725:
;main.c: 50: for(unsigned int j =0;j<1000;j++);
	movlw	high(0)
...
;; *************** function ___llmod *****************
;; Defined at:
;;		line 8 in file "/opt/microchip/xc8/v1.36/sources/common/llmod.c"
;; Parameters:    Size  Location     Type
...
psect	text3,class=CODE,space=0,reloc=2
	file	"/opt/microchip/xc8/v1.36/sources/common/llmod.c"
	line	8
global __ptext3
__ptext3:
psect	text3
