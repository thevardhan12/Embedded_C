...
l857:
;main.c: 31: unsigned char key;
;main.c: 32: char c;
;main.c: 33: init_config();
...
l67:
	line	36
;main.c: 35: {
;main.c: 36: key = read_digital_keypad(1);
	movlw	(01h)&0ffh
...
l861:
;main.c: 38: {
;main.c: 39: puts("switch 1 is pressed ");
		movlw	low(STR_1)
	movwf	((c:puts@s)),c
	movlw	high(STR_1)
	movwf	((c:puts@s+1)),c
...
l865:
;main.c: 42: {
;main.c: 43: puts("switch 2 is pressed ");
		movlw	low(STR_2)
	movwf	((c:puts@s)),c
	movlw	high(STR_2)
	movwf	((c:puts@s+1)),c
...
l869:
;main.c: 47: {
;main.c: 48: puts("switch 3 is pressed ");
		movlw	low(STR_3)
	movwf	((c:puts@s)),c
	movlw	high(STR_3)
	movwf	((c:puts@s+1)),c
...
l873:
;main.c: 52: {
;main.c: 53: puts("switch 4 is pressed ");
		movlw	low(STR_4)
	movwf	((c:puts@s)),c
	movlw	high(STR_4)
	movwf	((c:puts@s+1)),c
...
l785:
;main.c: 132: static unsigned char once = 1;
;main.c: 134: if (detection_type == 1)
...
l787:
;main.c: 135: {
;main.c: 136: if (((PORTC & 0x0f) != 0x0F) && once)
...
l799:
;main.c: 142: else if ((PORTC & 0x0f) == 0x0F)
	movf	((c:3970)),c,w	;volatile
	andlw	low(0Fh)
	xorlw	0Fh
	btfss	status,2
...
l803:
;main.c: 147: else if (detection_type == 0)
...
;;		 -> STR_4(21), STR_3(21), STR_2(21), STR_1(21), 
;; Auto vars:     Size  Location     Type
;;		None
;; Return value:  Size  Location     Type
;;                  2    1[COMRAM] int 
...
l745:
;main.c: 74: SENDB=1;
	bsf	c:(32099/8),(32099)&7	;volatile
	line	75
	
l747:
;main.c: 75: TRMT=1;
	bsf	c:(32097/8),(32097)&7	;volatile
	line	76
